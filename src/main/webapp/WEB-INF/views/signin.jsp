					...
					<form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" action="/sign-in" method="post">
						...
						<div class="text-center">
							...
							<div class="mb-10 text-center">
							    <a href="/oauth2/authorization/google" class="btn btn-light-danger fw-bolder w-100 mb-5">
							        <img alt="Logo" src="/assets/img/icon/google-icon.svg" class="h-20px me-3" />
							        Sign in with Google
							    </a>

							    <a href="/oauth2/authorization/facebook" class="btn btn-primary fw-bolder w-100 mb-5" style="background-color: #1877F2; border-color: #1877F2; color: white;">
							        <img alt="Logo" src="/assets/img/icon/facebook-4.svg" class="h-20px me-3" />
